              ...
              <tr key={reservation._id}>
                ...
                <td>
                  <td>
                    {!reservation.isApproved && (
                      <button
                          className="btn btn-outline btn-xs btn-warning mr-2" // Added mr-2 class for margin-right
                    ...
                    <button
                        ...
                        onClick={() => deleteHandler(reservation._id)} // Call deleteHandler with reservation ID
                       >
                       Remove
                    </button>
                  </td>
